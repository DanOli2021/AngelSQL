...
return api.OperationType switch
{
    ...
    "GetSale" => GetSale(api, translation),
    "GetPayment" => GetPayment(api, translation),
    "SavePayment" => SavePayment(api, translation),
    "DeletePayment" => DeletePayment(api, translation),
    "GetCreditSales" => GetCreditSales(api, translation),
    "GetSales" => GetSales(api, translation),
    ...
    "GetCurrencies" => GetCurrencies(api, translation),
...
string GetSale(AngelApiOperation api, Translations translation)
{
...
string GetPayment(AngelApiOperation api, Translations translation)
{
...
string SavePayment(AngelApiOperation api, Translations translation)
{
    ...
    Console.WriteLine($"Processing payment for Sale ID: {data.Sale_id}, Payment ID: {data.id}");
...
string DeletePayment(AngelApiOperation api, Translations translation)
{
...
string UpsertSale(AngelApiOperation api, Translations translation)
{
    ...
    foreach (Sale sale in sales)
    {
        ...
        //Console.WriteLine($"Sale {sale.Receipt_serie} {sale.Receipt_number}");
...
string GetSales(AngelApiOperation api, Translations translation)
{
...
string GetCreditSales(AngelApiOperation api, Translations translation)
{
...
string GetCurrencies(AngelApiOperation api, Translations translation)
{
